...
python3 train.py --img 1400 --batch 16 --epochs 10 --data /root/gbr/yolov5/reef_90_10_1982.yaml --weights /root/kaggle/yolov5/runs/train/split_90_10_5m6_onlyano_bs8_3/weights/epoch10.pt --name split_90_10_5m6_onlyano_bs8_ft_ --freeze 10 --hyp /root/gbr/yolov5/hyp.heavy.2.yaml --save-period 1
