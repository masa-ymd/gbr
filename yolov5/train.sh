...
python3 train.py --img 1280 --batch 16 --epochs 10 --data /root/gbr/yolov5/reef_90_10_1982.yaml --weights /root/kaggle/yolov5/runs/train/split_90_10_5s6_onlyano_bs8_/weights/last.pt --freeze 10 --name split_90_10_5s6_onlyano_bs8_ft --hyp /root/gbr/yolov5/hyp.heavy.2.yaml