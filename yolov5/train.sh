...
python3 train.py --img 2400 --batch 4 --epochs 15 --data /root/gbr/yolov5/reef_90_10_1982.yaml --weights yolov5s6.pt --name split_90_10_5s6_ --hyp /root/gbr/yolov5/hyp.heavy.2.yaml
