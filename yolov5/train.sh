...
python3 train.py --img 1500 --batch 8 --epochs 15 --data /root/gbr/yolov5/reef_90_10_1982.yaml --weights yolov5m6.pt --name split_90_10_5m6_onlyano_bs8_ --hyp /root/gbr/yolov5/hyp.heavy.2.yaml
