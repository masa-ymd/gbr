...
python3 train.py --img 4000 --batch 4 --epochs 20 --data /root/gbr/yolov5/reef_80_20_naive.yaml --weights yolov5l6.pt --name split_80_20_5l6 --hyp /root/gbr/yolov5/hyp.heavy.2.yaml