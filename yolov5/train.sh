...
python3 train.py --img 2400 --batch 2 --epochs 2 --data /root/gbr/yolov5/reef_90_10_naive.yaml --weights /root/kaggle/yolov5/runs/train/split_90_10_5l68/weights/last.pt --name split_90_10_5l6 --hyp /root/gbr/yolov5/hyp.heavy.2.yaml