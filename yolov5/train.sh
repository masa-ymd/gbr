...
python3 train.py --img 2400 --batch 2 --epochs 3 --data /root/gbr/yolov5/reef_90_10_naive.yaml --weights yolov5l6.pt  --name split_90_10_5l6 --hyp /root/gbr/yolov5/hyp.heavy.2.yaml